...
import Collegee from "../Images/hero4.png"
    ...
    <> <div className='bg-gray-100'>
      <div className="w-full h-full bg-gray-100 dark:bg-gray-800">
        <div className="w-full mx-auto py-10  dark:bg-gray-800">
          <h1 className="text-green-700 w-[92%] mx-auto lg:text-4xl md:text-3xl xs:text-2xl text-center font-serif font-semibold pb-8 pt-14 dark:text-white">
            COLLEGE
          </h1>
          {/* Blog Cover */}
          <img
          ...
          <div className="py-6  dark:bg-gray-800">
            <div className="md:w-[80%] xs:w-[90%] mx-auto pt-4">
              ...
              <h1 className="text-green-700 font-semibold text-lg mt-4 dark:text-white">
                1. Nos Objectifs :
              </h1>
