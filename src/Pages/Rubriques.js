...
const Rubriques = () => {
  ...
  return (
    <>
      {/* <p>
        L'écho du Quotidien, Projets qui Changent Tout, La Scène Parascolaire, À Table, C'est l'Actu !
        Planète École, Les Voix de l'École, École Citoyenne, Créations Écolières, L'École du Futur,
        Bien-Être à l'École, Le Monde en Perspective, Les Étoiles de Notre École, Sport et Esprit d'Équipe, Culture et Découvertes
      </p> */}
      <div className='bg-gray-100'>
        ...
        <div className="bg-gray-800 py-4"></div>
        {/* --------------------------------------------------------------------------------- */}
        <main className="container mx-auto mt-0">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-8/12 px-4 mb-0">
              <div className="relative p-4">
                <div className="max-w-3xl mx-auto">
                  <div className="mt-3 bg-gray-100 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <div className="">
                      <a
                        href="/"
                        className="text-gray-800 hover:text-gray-700 transition duration-500 ease-in-out text-sm"
            ...
            <div className="w-full md:w-4/12 lg:w-4/12 mt-0 md:mt-14 px-4 mb-8">
              <div className="bg-gray-50 ml-4 lg:ml-10 lg:pl-10 px-4 py-6 rounded-lg sticky top-4 border-2 border-gray-300 border-dashed w-11/12">
                <h3 className="text-xl font-bold mb-3 ml-8 text-amber-300 border-b-2 border-amber-300 w-1/2">RUBRIQUES</h3>
                <ul className="list-none list-inside">
                  <li>
